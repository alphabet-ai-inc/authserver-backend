...
func TestThisApp(t *testing.T) {
	...
	expectedJSON := `{"id":1,"name":"Test App","release":"1.0.0","path":"/test/path","init":"init.sh","web":"http://testapp.com","title":"Test Application","created":1660000000,"updated":1660000001}`
